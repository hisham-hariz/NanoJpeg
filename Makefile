...
testbench_mod.vvp: testbench_mod.v axi4_mem_periph.v picorv32.v rowidct.v 
	$(IVERILOG) -o $@ $(subst C,-DCOMPRESSED_ISA,$(COMPRESSED_ISA)) $^
	chmod -x $@
...
testbench_verilator: testbench_mod.v picorv32.v axi4_mem_periph.v rowidct.v testbench.cc 
	$(VERILATOR) --cc --exe -Wno-lint -trace --top-module picorv32_wrapper testbench_mod.v picorv32.v axi4_mem_periph.v rowidct.v testbench.cc \
